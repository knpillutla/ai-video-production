"""Upload 4K Focus Masters & Pure Rain Variants to Rain & Quill (@RainAndQuill)."""
...
def main():
    parser = argparse.ArgumentParser(description="Upload 4K Masters to Rain & Quill YouTube Channel")
    parser.add_argument("--id", type=str, required=True, help="Episode ID to upload (e.g. ep_beach_house_1790365123)")
    ...
    channel_dir = Path("storage/channels/rain_and_quill") / args.id
