"""Upload 4K Sleep Masters & Pure Nature Variants to Silent Hearth (@SilentHearthSleep)."""
...
def main():
    parser = argparse.ArgumentParser(description="Upload 4K Masters to Silent Hearth YouTube Channel")
    parser.add_argument("--id", type=str, required=True, help="Episode ID to upload (e.g. ep_blizzard_1790363895)")
    ...
    channel_dir = Path("storage/channels/silent_hearth") / args.id
