...
def build_dance_storyboard_prompt(
    ...
    return (
        ...
        "3. RAW 35MM CINEMATIC FILM REALISM (ZERO PLASTIC / AI SHEEN): Prompts must depict raw, photorealistic 35mm film still photography (shot on Arri Alexa 35mm Master Prime lens, natural ambient daylight, authentic handloom fabric texture). All characters must be fully clothed in complete modest attire. Strictly prohibit smooth airbrushed skin, CGI gloss, doll-like wax texture, nudity, bare chest, or artificial yellow glow.\n"
